  ...
  if(!empty(trim($username)) && !empty(trim($password))    && !empty(trim($level)) ){
        ...
        if(cekTambahUser($username) ) {
                //memasukkan user ke database
                    if(tambahakunPembina($username,$password,$email,$firstname,$lastname,$studentid,$level)){
...
<div class="panel panel-default">
  <div class="panel-body">
    ...
    <div class="col-md-12 col-sm-6 col-xs-4">
                ...
                <h4 class="modal-title" id="myModalLabel"><span class="glyphicon glyphicon-plus-sign" aria-hidden="true"></span>&nbsp;&nbsp;&nbsp;Tambah User Pembina</h4>
                <hr>
    ...
    <div class="panel-heading">
        <p>2. Detail Pembina</p>
    </div>

    <div class="panel-body">

                <div class="form-group">
                    <label class="control-label" for="inputSmall">NIP<small class="text-danger" style="font-size: 13px;"><i>*</i></small></label>
                    <input type="text" name="studentid"  class="form-control input-sm" placeholder="Studentid" autofocus/>
                </div>
    ...
    <div class="panel-body">
        ...
        <p style="font-size: 12px;"> Simpan akun sebagai user <span class="glyphicon glyphicon-question-sign" aria-hidden="true"></span></p>
                ...
                <button name="simpan" class="btn btn-success btn-sm btn-block" type="submit" style="margin-bottom: 20px">
                Buat Akun
                </button>
